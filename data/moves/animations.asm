...
BattleAnim_Wish:
	...
	anim_obj ANIM_OBJ_WISH, 30, 46, $42
	anim_wait 16
	anim_obj ANIM_OBJ_WISH2, 50, 50, $0
	anim_wait 16
	anim_obj ANIM_OBJ_WISH2, 70, 52, $0
	anim_wait 16
	anim_obj ANIM_OBJ_WISH2, 90, 56, $0
	anim_wait 16
	anim_obj ANIM_OBJ_WISH2, 110, 60, $0
	anim_wait 16
	anim_obj ANIM_OBJ_WISH2, 130, 64, $0
	anim_wait 80
	anim_clearobjs
...
BattleAnim_DragonHammer:
	...
	anim_sound 0, 1, SFX_EGG_BOMB
	anim_obj ANIM_OBJ_HIT_BIG_YFIX, 136, 48, $0
	anim_obj ANIM_OBJ_04, 116, 56, $0
	anim_obj ANIM_OBJ_04, 156, 56, $0
	anim_wait 1
	anim_bgeffect ANIM_BG_SHAKE_SCREEN_X, $40, $4, $10
...
.loop
	...
	anim_incbgeffect ANIM_BG_18
	anim_wait 1
	anim_jump BattleAnim_FocusEnergy
...
.loop
	...
	anim_wait 8
	anim_sound 0, 1, SFX_SHINE
	anim_obj ANIM_OBJ_POLISH_1, 48, 104, $0
	anim_wait 8
	anim_sound 0, 1, SFX_SHINE
	anim_obj ANIM_OBJ_POLISH_2, 48, 72, $0
	anim_wait 8
	anim_sound 0, 1, SFX_SHINE
...
.loop
	...
	anim_call BattleAnim_ShowMon_0
	anim_call BattleAnim_RazorWind_branch_c9fb5
	anim_ret
...
BattleAnim_WillOWisp:
	...
	anim_sound 0, 0, SFX_CURSE
.loop
	anim_obj ANIM_OBJ_BLUE_FLAME, 120, 52, $10
	anim_wait 6
	anim_obj ANIM_OBJ_BLUE_FLAME, 146, 52, $90
	anim_loop 2, .loop
	anim_wait 32
	anim_ret
...
BattleAnim_IcicleCrash:
	anim_2gfx ANIM_GFX_ICICLE, ANIM_GFX_HIT
	anim_bgeffect ANIM_BG_SHAKE_SCREEN_X, $28, $2, $0
	anim_sound 0, 1, SFX_MEGA_PUNCH
	anim_obj ANIM_OBJ_ICICLE,  128, 250, $10
	anim_wait 4
	anim_obj ANIM_OBJ_ICICLE,  120, 250, $10
	anim_wait 4
	anim_sound 6, 2, SFX_STOMP
	anim_obj ANIM_OBJ_01, 128, 66, $0
	anim_obj ANIM_OBJ_ICICLE,  152, 250, $10
	anim_wait 4
	anim_sound 6, 2, SFX_STOMP
	anim_obj ANIM_OBJ_01, 120, 66, $0
	anim_obj ANIM_OBJ_ICICLE,  144, 250, $10
	anim_wait 4
	anim_sound 6, 2, SFX_STOMP
	anim_obj ANIM_OBJ_01, 152, 66, $0
	anim_obj ANIM_OBJ_ICICLE,  136, 250, $10
	anim_wait 4
	anim_sound 6, 2, SFX_STOMP
	anim_obj ANIM_OBJ_01, 144, 66, $0
	anim_wait 4
	anim_sound 6, 2, SFX_STOMP
	anim_obj ANIM_OBJ_01, 136, 66, $0
	anim_wait 32
	anim_ret
...
BattleAnim_Waterfall:
	...
	anim_obj ANIM_OBJ_WATER_HIT, -15, 0,   7, 0, $0
	anim_wait 3
	anim_sound 0, 1, SFX_LICK
	anim_obj ANIM_OBJ_WATER_HIT, -15, 0,   6, 0, $0
	anim_wait 3
	anim_sound 0, 1, SFX_LICK
	anim_obj ANIM_OBJ_WATER_HIT, -15, 0,   5, 0, $0
	anim_wait 3
	anim_sound 0, 1, SFX_LICK
	anim_obj ANIM_OBJ_WATER_HIT, -15, 0,   4, 0, $0
	anim_wait 3
	anim_sound 0, 1, SFX_LICK
	anim_obj ANIM_OBJ_WATER_HIT, -15, 0,   3, 0, $0
	anim_wait 8
	anim_ret
...
BattleAnim_ZapCannon:
	...
	anim_obj ANIM_OBJ_ZAP_CANNON,   8, 0,  11, 4, $0
	anim_wait 20
	anim_clearobjs
...
BattleAnim_ElectroBall:
	...
	anim_bgeffect ANIM_BG_06, $0, $2, $0
	anim_obj ANIM_OBJ_CHARGE, 44, 90, $30
	anim_obj ANIM_OBJ_CHARGE, 44, 90, $31
	anim_obj ANIM_OBJ_CHARGE, 44, 90, $32
	anim_obj ANIM_OBJ_CHARGE, 44, 90, $33
	anim_obj ANIM_OBJ_CHARGE, 44, 90, $34
	anim_obj ANIM_OBJ_CHARGE, 44, 90, $35
	anim_obj ANIM_OBJ_CHARGE, 44, 90, $36
	anim_obj ANIM_OBJ_CHARGE, 44, 90, $37
.loop
	anim_sound 0, 0, SFX_SWORDS_DANCE
	anim_wait 8
	anim_loop 4, .loop
...
BattleAnim_FlameBurst:
	...
	anim_wait 16
	anim_sound 0, 1, SFX_MEGA_PUNCH
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $04
	anim_wait 1
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $2c
	anim_wait 1
	anim_sound 0, 1, SFX_MEGA_PUNCH
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $14
	anim_wait 1
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $34
	anim_wait 1
	anim_sound 0, 1, SFX_MEGA_PUNCH
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $10
	anim_wait 1
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $38
	anim_wait 1
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $20
	anim_wait 1
	anim_wait 32
	anim_ret
...
.loop
	...
	anim_bgeffect ANIM_BG_FLASH_INVERTED, $0, $4, $2
	anim_sound 0, 0, SFX_BURN
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $0
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $8
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $10
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $18
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $20
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $28
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $30
	anim_obj ANIM_OBJ_FLARE_BLITZ_2, 136, 48, $38
	anim_wait 2
	anim_sound 0, 0, SFX_BURN
	anim_wait 2
